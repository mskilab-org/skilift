...
pairs_table <- data.table(
  ...
  treatment = c("Carboplatin", "Nivolumab", "Abiraterone"),
  treatment_type = c("Chemotherapy", "Immunotherapy", "Hormonal Therapy"),
  treatment_best_response = c("SD", "PR", "PD"),
  treatment_duration = c(62, 120, 45),
...
samplesheet <- data.table(
  ...
  treatment = c("Carboplatin"),
  treatment_type = c("Chemotherapy"),
  treatment_best_response = c("SD"),
  treatment_duration = c(62),
